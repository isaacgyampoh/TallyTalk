...
export const SAMPLE_CONTACTS: SampleContact[] = [
  {
    ...
    tasks: [
      { id: 't1', title: 'Send me the final Ecobank document', direction: 'they_owe_me', status: 'active', priority: 'urgent', expected: 'Today', overdue: true, note: 'The signed PDF, not the scan.' },
      ...
      { id: 't4', title: 'Pay back the taxi money', direction: 'i_owe_them', status: 'active', priority: 'normal', expected: 'This Week', note: 'GHS 60' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 't6b', title: 'Send the guest list', direction: 'they_owe_me', status: 'active', priority: 'low', expected: 'Next Week' },
    ],
  },
  {
    id: 'kwame',
    ...
    tasks: [
      { id: 't7', title: 'Finish the Q3 slide deck', direction: 'i_owe_them', status: 'active', priority: 'urgent', expected: 'Today', note: '12 slides, board review Friday.' },
  ...
  },
  {
    ...
    tasks: [
      { id: 't11', title: 'Approve the invoice', direction: 'they_owe_me', status: 'completed', priority: 'normal', expected: 'This Week' },
    ],
  },
  {
    id: 'adjoa',
    ...
    tasks: [
      { id: 't12', title: 'Send the fabric samples', direction: 'they_owe_me', status: 'pending_acceptance', priority: 'normal', expected: 'This Week' },
    ],
  },
]
...
export const SAMPLE_GROUPS: SampleGroup[] = [
  {
    ...
    tasks: [
      { id: 'gt1', title: 'Confirm the caterer headcount', assignee: 'Ama Serwaa', done: false, priority: 'high' },
      { id: 'gt2', title: 'Finalise the seating chart', assignee: 'You', done: false, priority: 'normal' },
      { id: 'gt3', title: 'Order the invitation cards', assignee: 'Efua Boateng', done: false, priority: 'urgent' },
      { id: 'gt4', title: 'Book the decorator', assignee: 'Adjoa Nyarko', done: false, priority: 'normal' },
      { id: 'gt5', title: 'Pay the venue deposit', assignee: 'Ben Owusu', done: true, priority: 'high' },
      { id: 'gt6', title: 'Send the save-the-dates', assignee: 'You', done: true, priority: 'normal' },
    ],
  },
  {
    id: 'g2',
    ...
    tasks: [
      { id: 'st1', title: 'Follow up with Melcom account', assignee: 'Kwame Mensah', done: false, priority: 'urgent' },
      { id: 'st2', title: 'Send July pipeline report', assignee: 'You', done: false, priority: 'high' },
      { id: 'st3', title: 'Onboard the new distributor', assignee: 'Yaw Darko', done: false, priority: 'normal' },
      { id: 'st4', title: 'Update the CRM records', assignee: 'Adjoa Nyarko', done: true, priority: 'low' },
    ],
  },
]
